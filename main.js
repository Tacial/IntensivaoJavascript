...
for (const produtoCatalogo of catalogo) {
    const cartaoProduto = `<div id="card-produto-1" style="border: 1px blue;">
    <img src="./assets/img/${produtoCatalogo.imagem}" alt="Produto 1 do e-commerce" style="height: 300px" />
